...
impl IterationStatement {
    pub fn parse(parser: &mut Parser, scanner: Scanner, yield_flag: bool, await_flag: bool, return_flag: bool) -> ParseResult<Self> {
        Err(ParseError2 { code: PECode::ParseNodeExpected(ParseNodeKind::IterationStatement), location: scanner.into() })
            .otherwise(|| {
...
impl ForStatement {
    pub fn parse(parser: &mut Parser, scanner: Scanner, yield_flag: bool, await_flag: bool, return_flag: bool) -> ParseResult<Self> {
        ...
        Err(ParseError2 { code: PECode::ForStatementDefinitionError, location: after_open.into() })
            .otherwise(|| {
            ...
            .otherwise(|| {
                ...
                if lookahead1.matches_keyword(Keyword::Let) {
                    ...
                    if lookahead2.matches_punct(Punctuator::LeftBracket) {
                        ...
                        return Err(ParseError2 { code: PECode::Generic, location: after_open.into() });
                    }
                }
...
impl ForInOfStatement {
    pub fn parse(parser: &mut Parser, scanner: Scanner, yield_flag: bool, await_flag: bool, return_flag: bool) -> ParseResult<Self> {
        ...
        Err(ParseError2 { code: PECode::ForInOfDefinitionError, location: after_open.into() })
            .otherwise(|| {
                // for var
                let after_var = scan_for_keyword(after_open, parser.source, ScanGoal::InputElementRegExp, Keyword::Var)?;
...
impl ForBinding {
    fn parse_core(parser: &mut Parser, scanner: Scanner, yield_flag: bool, await_flag: bool) -> ParseResult<Self> {
        Err(ParseError2 { code: PECode::ParseNodeExpected(ParseNodeKind::ForBinding), location: scanner.into() })
            .otherwise(|| {
