...
impl Object {
    ...
    //  4. Return false.
    pub fn is_array(&self, _agent: &Agent) -> Completion<bool> {
...
impl Agent {
    pub fn ordinary_has_instance(&self, c: &ECMAScriptValue, o: &ECMAScriptValue) -> Completion<bool> {
