...
mod insn {
    ...
    #[test_case(Insn::AttachElements => "ATTACH_ELEMENTS"; "AttachElements instruction")]
    #[test_case(Insn::AttachSourceText => "ATTACH_SOURCE"; "AttachSourceText instruction")]
    #[test_case(Insn::Bigint => "BIGINT"; "Bigint instruction")]
    #[test_case(Insn::BindThisAndInit => "BIND_THIS_AND_INIT"; "BindThisAndInit instruction")]
    ...
    #[test_case(Insn::ConstructorCheck => "CSTR_CHECK"; "ConstructorCheck instruction")]
    ...
    #[test_case(Insn::CreateDefaultConstructor => "DEFAULT_CSTR"; "CreateDefaultConstructor instruction")]
    ...
    #[test_case(Insn::CreatePrivateNameIfMissing => "CPNIM"; "CreatePrivateNameIfMissing instruction")]
    ...
    #[test_case(Insn::DefineSetter => "DEF_SETTER"; "DefineSetter instruction")]
    ...
    #[test_case(Insn::EvaluateInitializedClassStaticFieldDefinition => "EVAL_CLS_STC_FLD_DEF"; "EvaluateInitializedClassStaticFieldDefinition instruction")]
    ...
    #[test_case(Insn::GeneratorStartFromFunction => "GEN_START"; "GeneratorStartFromFunction instruction")]
    #[test_case(Insn::GetLexBinding => "GLB"; "GetLexBinding instruction")]
    #[test_case(Insn::GetNewTarget => "GET_NEW_TARGET"; "GetNewTarget instruction")]
    #[test_case(Insn::GetParentsFromSuperclass => "GPFS"; "GetParentsFromSuperclass instruction")]
    #[test_case(Insn::GetSuperConstructor => "GET_SUPER_CSTR"; "GetSuperConstructor instruction")]
    #[test_case(Insn::GetSyncIterator => "GET_SYNC_ITER"; "GetSyncIterator instruction")]
    #[test_case(Insn::GetTemplateObject => "GET_TMPL_OBJ"; "GetTemplateObject instruction")]
    ...
    #[test_case(Insn::InstantiateGeneratorFunctionExpression => "FUNC_GENE"; "InstantiateGeneratorFunctionExpression instruction")]
    #[test_case(Insn::InstantiateGeneratorFunctionObject => "FUNC_GENO"; "InstantiateGeneratorFunctionObject instruction")]
    #[test_case(Insn::InstantiateGeneratorMethod => "GEN_METHOD"; "InstantiateGeneratorMethod instruction")]
    ...
    #[test_case(Insn::ListToArray => "LIST_TO_ARRAY"; "ListToArray instruction")]
    #[test_case(Insn::LoopContinues => "LOOP_CONT"; "LoopContinues instruction")]
    #[test_case(Insn::MakeClassConstructorAndSetName => "MAKE_CC_SN"; "MakeClassConstructorAndSetName instruction")]
    #[test_case(Insn::MakeConstructor => "MAKE_CSTR"; "MakeConstructor instruction")]
    #[test_case(Insn::MakeConstructorWithProto => "MAKE_CSTR_PROTO"; "MakeConstructorWithProto instruction")]
    #[test_case(Insn::MakePrivateReference => "PRIVATE_REF"; "MakePrivateReference instruction")]
    #[test_case(Insn::MakeSuperPropertyReference => "SUPER_REF"; "MakeSuperPropertyReference instruction")]
    #[test_case(Insn::Modulo => "MODULO"; "Modulo instruction")]
    #[test_case(Insn::Multiply => "MULTIPLY"; "Multiply instruction")]
    #[test_case(Insn::NameOnlyFieldRecord => "NAME_ONLY_FIELD_REC"; "NameOnlyFieldRecord instruction")]
    #[test_case(Insn::NameOnlyStaticFieldRecord => "NAME_ONLY_STATIC_FIELD"; "NameOnlyStaticFieldRecord instruction")]
    ...
    #[test_case(Insn::ObjectPrototype => "OBJ_PROTO"; "ObjectPrototype instruction")]
    #[test_case(Insn::ObjectWithProto => "OBJ_WITH_PROTO"; "ObjectWithProto instruction")]
    ...
    #[test_case(Insn::PopPrivateEnv => "PPE"; "PopPrivateEnv instruction")]
    ...
    #[test_case(Insn::PushNewPrivateEnv => "PNPE"; "PushNewPrivateEnv instruction")]
    #[test_case(Insn::PushNewVarEnvFromLex => "PNVEFL"; "PushNewVarEnvFromLex instruction")]
    #[test_case(Insn::PushWithEnv => "PWE"; "PushWithEnv instruction")]
    #[test_case(Insn::PutValue => "PUT_VALUE"; "PutValue instruction")]
    #[test_case(Insn::Ref => "REF"; "Ref instruction")]
    #[test_case(Insn::RegExpCreate => "REGEXP"; "RegExpCreate instruction")]
    ...
    #[test_case(Insn::RestoreLexEnv => "RLE"; "RestoreLexEnv instruction")]
    ...
    #[test_case(Insn::RotateListDown => "ROTATE_LIST_DOWN"; "RotateListDown instruction")]
    #[test_case(Insn::RotateListUp => "ROTATE_LIST_UP"; "RotateListUp instruction")]
    #[test_case(Insn::RotateUp => "ROTATEUP"; "RotateUp instruction")]
    #[test_case(Insn::SetAsideLexEnv => "SALE"; "SetAsideLexEnv instruction")]
    #[test_case(Insn::SetDerived => "SET_DERIVED"; "SetDerived instruction")]
    ...
    #[test_case(Insn::StaticClassItem => "STATIC_ITEM"; "StaticClassItem instruction")]
    ...
    #[test_case(Insn::TailCall => "TAIL_CALL"; "TailCall instruction")]
    ...
    #[test_case(Insn::UndefinedIfEmpty => "UNDEFINED_IF_EMPTY"; "UndefinedIfEmpty instruction")]
    ...
    #[test_case(Insn::Yield => "YIELD"; "Yield instruction")]
...
mod nameable_production {
    ...
    #[test_case("async function*(){}", true => Ok((svec(&["<AsyncGenerator Instructions 1>"]), true, false)); "async generator expression")]
    ...
    #[test_case("(async x => x)", true => Ok((svec(&["<AsyncArrowFunction Instructions 1>"]), true, false)); "async arrow function")]
    fn compile_named_evaluation(src: &str, strict: bool) -> Result<(Vec<String>, bool, bool), String> {
        ...
        match &node {
            ...
            NameableProduction::AsyncArrow(node) => {
                node.named_evaluation(&mut inner, strict, &ast, Some(NameLoc::Index(innerid))).unwrap();
                inner.set_name("AsyncArrowFunction");
            }
            NameableProduction::AsyncGenerator(node) => {
                node.named_evaluation(&mut inner, strict, &ast, Some(NameLoc::Index(innerid))).unwrap();
                inner.set_name("AsyncGenerator");
            }
    ...
    for &(section, slots_left) in what {
        match section {
            ...
            Fillable::FunctionStash => {
                ...
                let (func_def, ast) = Maker::new(src).function_declaration_ast();
                let ast = Rc::new(ast);
...
mod primary_expression {
    ...
    mod compile {
        ...
        #[test_case("async function (){}", true => Ok(svec(&["<AsyncFunction Instructions 1>"])); "async function expression")]
        #[test_case("async function *(){}", true => Ok(svec(&["<AsyncGenerator Instructions 1>"])); "async generator expression")]
        ...
        fn normal(src: &str, strict: bool) -> Result<Vec<String>, String> {
            ...
            match node.as_ref() {
                ...
                PrimaryExpression::AsyncFunction { node } => {
                    node.compile(&mut inner, strict, &ast).unwrap();
                    inner.set_name("AsyncFunction");
                }
...
mod call_member_expression {
    ...
    #[test_case("a()", true, None => Ok((svec(&["00001: a()", "STRING 0 (a)", "STRICT_RESOLVE", "DUP", "GET_VALUE", "JUMP_IF_NORMAL 4", "UNWIND 1", "JUMP 3", "FLOAT 0 (0)", "CALL"]), true, false)); "no args; strict")]
    ...
    #[test_case("(1)()", true, None => Ok((svec(&["00001: (1)()", "FLOAT 0 (1)", "DUP", "FLOAT 1 (0)", "CALL"]), true, false)); "me not reference")]
    #[test_case("a(b)", true, Some(1) => serr("Out of room for strings in this compilation unit"); "no space for args")]
    #[test_case("a(c)", true, None => Ok((svec(&["00001: a(c)", "STRING 0 (a)", "STRICT_RESOLVE", "DUP", "GET_VALUE", "JUMP_IF_NORMAL 4", "UNWIND 1", "JUMP 15", "STRING 1 (c)", "STRICT_RESOLVE", "GET_VALUE", "JUMP_IF_ABRUPT 2", "FLOAT 0 (1)", "JUMP_IF_NORMAL 4", "UNWIND 2", "JUMP 1", "CALL"]), true, false)); "args can error; strict")]
...
mod fcn_def {
    ...
    #[test_case(agendecl, true => Ok((svec(&["00001: async function *a() {}", "IAGO 0 a"]), true, false)); "async generator decl")]
...
mod compile_fdi {
    ...
    fn function(src: &str, strict: bool) -> (StashedFunctionData, Rc<SourceTree>) {
    ...
    fn insane(strict: bool) -> (StashedFunctionData, Rc<SourceTree>) {
    ...
    fn compile_fdi(
        make_function: impl FnOnce(bool) -> (StashedFunctionData, Rc<SourceTree>),
        strict: bool,
        what: &[(Fillable, usize)],
    ) -> Result<(Vec<String>, bool), String> {
...
mod assignment_element {
    ...
    #[test_case("a=@@(2)", true, &[] => serr("AE: IDAE: Location hv01"); "izer too big")]
    #[test_case("[a[1n]]", true, &[(Fillable::BigInt, 0)] => serr("Out of room for big ints in this compilation unit"); "dstr fail")]
    #[test_case("a=@@(15)", true, &[] => serr("AE: IDAE: Location uw1a"); "izer too big v2")]
    #[test_case("0=@@(11)", true, &[] => serr("AE: IDAE: Location uw1b"); "izer too big v3")]
    #[test_case("[a[@@(39)]]=q", true, &[] => serr("AE: IDAE: Location uw1c"); "dstr too big")]
    #[test_case("[a[@@(37)]]", true, &[] => serr("AE: IDAE: Location ex01"); "dstr too big v2")]
    fn iterator_destructuring_assignment_evaluation(
        src: &str,
        strict: bool,
        what: &[(Fillable, usize)],
...
mod assignment_elision_element {
    ...
    #[test_case(",a[@@(23)]", true, &[] => serr("AEE: IDAE"); "elem too big")]
    fn iterator_destructuring_assignment_evaluation(
        src: &str,
        strict: bool,
        what: &[(Fillable, usize)],
...
mod assignment_element_list {
    ...
    #[test_case("a,b[@@(23)]", true, &[] => serr("out of range integral type conversion attempted"); "item too big")]
    fn iterator_destructuring_assignment_evaluation(
        src: &str,
        strict: bool,
        what: &[(Fillable, usize)],
...
mod array_assignment_pattern {
    ...
    #[test_case("[a,,...b[@@(37)]]", true, &[] => serr("ArrayAssignmentPattern::destructuring_assignment_evaluate: Location LRU1"); "l+e+r; rest too big")]
    #[test_case("[a,,...b[@@(28)]]", true, &[] => serr("ArrayAssignmentPattern::destructuring_assignment_evaluate: Location LRU2"); "l+e+r; rest too big v2")]
    fn destructuring_assignment_evaluation(
        src: &str,
        strict: bool,
        what: &[(Fillable, usize)],
...
mod object_assignment_pattern {
    ...
    #[test_case("{a,...b[@@(31)]}", true, &[] => serr("OAP: location LR01"); "list-rest; rest too big")]
    #[test_case("{a=@@(37),...b}", true, &[] => serr("OAP: location LR02"); "list-rest; list too big")]
    fn destructuring_assignment_evaluation(
        src: &str,
        strict: bool,
        what: &[(Fillable, usize)],
...
mod class_static_block {
    ...
    fn class_static_block_definition_evaluation(src: &str, what: &[(Fillable, usize)]) -> Result<Vec<String>, String> {
        let (node, ast) = Maker::new(src).class_static_block_ast();
        let ast = Rc::new(ast);
        let mut c = complex_filled_chunk("x", what);

        node.class_static_block_definition_evaluation(&mut c, &ast)
            .map_err(|e| e.to_string())
            .map(|_| c.disassemble(src).iter().map(String::as_str).filter_map(disasm_filt).collect::<Vec<_>>())
    }
}
...
mod optional_chain {
    ...
    #[test_case(
        "?.()", true, &[]
        => Ok((svec(&["00001: ?.()", "FLOAT 0 (0)", "CALL"]), true, false));
        "oc: args; success"
    )]
    #[test_case(
        "?.[0]", true, &[]
