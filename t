...
test_defs[StringObject_is_ordinary]="StringObject@ObjectInterface::is_ordinary string_object::is_ordinary string_object"
...
test_defs[Agent_string_create]="agent::Agent::string_create agent::string_create string_object"
test_defs[Agent_create_string_object]="agent::Agent::create_string_object agent::create_string_object string_object"
test_defs[Agent_provision_string_intrinsic]="agent::Agent::provision_string_intrinsic agent::provision_string_intrinsic string_object"
test_defs[string_constructor_function]="string_constructor_function string_constructor_function string_object"
test_defs[Agent_this_string_value]="agent::Agent::this_string_value agent::this_string_value string_object"
...
test_defs[GeneratorObject_is_ordinary]="GeneratorObject@ObjectInterface::is_ordinary generator_object::is_ordinary control_abstraction"
...
test_defs[Agent_generator_validate]="agent::Agent::generator_validate agent::generator_validate control_abstraction"
